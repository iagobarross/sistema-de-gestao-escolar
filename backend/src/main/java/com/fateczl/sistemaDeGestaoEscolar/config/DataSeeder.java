...
public class DataSeeder implements CommandLineRunner {
    ...
    private void popularEscola1() {
        ...
        criarFunc("Guilherme Fernandes Costa", "secretaria@viver.com.br", Role.SECRETARIA, Funcionario.Cargo.SECRETARIA,
                esc);
    ...
    private void popularEscola2() {
        ...
        criarFunc("Lucas Silva Souza", "secretaria@aprender.com.br", Role.SECRETARIA, Funcionario.Cargo.SECRETARIA,
                esc);
    ...
    private void popularEscola3() {
        ...
        criarFunc("Nicolas Fernandes Martins", "secretaria@saber.com.br", Role.SECRETARIA, Funcionario.Cargo.SECRETARIA,
                esc);
    ...
    private void popularEscola4() {
        ...
        // --- Funcionários ---
        criarFunc("João Rodrigues Oliveira", "diretor@pingodegente.com.br", Role.DIRETOR, Funcionario.Cargo.DIRETOR,
                esc);
    ...
    private void popularEscola6() {
        ...
        criarFunc("Bruno Ribeiro Rodrigues", "coordenador@raiodeluz.com.br", Role.COORDENADOR,
                Funcionario.Cargo.COORDENADOR, esc);
        criarFunc("Nicolas Vieira Martins", "professor@raiodeluz.com.br", Role.PROFESSOR, Funcionario.Cargo.PROFESSOR,
                esc);
    ...
    private void popularEscola7() {
        ...
        criarFunc("Sophia Cruz Vieira", "secretaria@solnascente.com.br", Role.SECRETARIA, Funcionario.Cargo.SECRETARIA,
                esc);
        criarFunc("Carlos Costa Ferreira", "coordenador@solnascente.com.br", Role.COORDENADOR,
                Funcionario.Cargo.COORDENADOR, esc);
        criarFunc("Eduardo Alves Almeida", "professor@solnascente.com.br", Role.PROFESSOR, Funcionario.Cargo.PROFESSOR,
                esc);
    ...
    private void popularEscola8() {
        ...
        criarFunc("Guilherme Lima Ribeiro", "secretaria@objetivo.com.br", Role.SECRETARIA, Funcionario.Cargo.SECRETARIA,
                esc);
        criarFunc("Daniela Gomes Cruz", "coordenador@objetivo.com.br", Role.COORDENADOR, Funcionario.Cargo.COORDENADOR,
                esc);
        criarFunc("Daniela Ferreira Vieira", "professor@objetivo.com.br", Role.PROFESSOR, Funcionario.Cargo.PROFESSOR,
                esc);
    ...
    private void popularEscola9() {
        ...
        criarFunc("Olivia Ribeiro Costa", "coordenador@novageracao.com.br", Role.COORDENADOR,
                Funcionario.Cargo.COORDENADOR, esc);
        criarFunc("Olivia Martins Silva", "professor@novageracao.com.br", Role.PROFESSOR, Funcionario.Cargo.PROFESSOR,
                esc);
    ...
    private Responsavel criarResp(String nome, String cpf) {
        ...
        Responsavel r = new Responsavel(null, nome, email, passwordEncoder.encode("123456"), true, LocalDateTime.now(),
    ...
    private Aluno criarAluno(String nome, String ra, Responsavel r, Escola e) {
        ...
        Aluno a = new Aluno(null, nome, email, passwordEncoder.encode("aluno123"), true, LocalDateTime.now(), ra,
    ...
    protected void vincularMatrizesParaTodasAsTurmas() {
        ...
        for (Turma turma : todasTurmas) {
            ...
            if (turma.getAlunos() == null || turma.getAlunos().isEmpty()) continue;
            ...
            if (discMap.containsKey("POR")) criarMatriz(turma, discMap.get("POR"), professor, 100);
            if (discMap.containsKey("MAT")) criarMatriz(turma, discMap.get("MAT"), professor, 100);
